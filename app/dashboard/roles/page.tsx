        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          {showNewStudent && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-gray-50 p-4 rounded-lg">
              ...
              <input type="date" value={newStudent.birth_date} onChange={(e) => setNewStudent({...newStudent, birth_date: e.target.value})} className="h-10 px-3 border border-gray-300 rounded-lg" />
      ...
      {step === 2 && selectedStudent && (
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <input type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} className="h-10 px-3 border border-gray-300 rounded-lg" />
            <input type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} className="h-10 px-3 border border-gray-300 rounded-lg" placeholder="Date de fin (optionnel)" />
          </div>
