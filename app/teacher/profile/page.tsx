...
import {
  User, RefreshCw, Mail, Phone, Building2, GraduationCap, KeyRound, Check, Save,
} from 'lucide-react'
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (staff) {
        ...
        setCustomType(staff.custom_type || null)
      }
    } catch (e: any) {
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-4">
        <span className="grid h-16 w-16 place-items-center rounded-full bg-sky-100 text-sky-800 text-2xl font-bold flex-shrink-0">
        ...
        <div className="min-w-0">
          ...
          {customType && (
            <span className="inline-block mt-1 text-xs bg-sky-50 text-sky-700 px-2 py-0.5 rounded-md">
              {customType}
            </span>
          )}
        </div>
